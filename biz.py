...
icon = Image.open("Screenshot 2024-03-05 105457.png")
st.set_page_config(page_title= "Biz-Card-Visualization",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This OCR app is created by *Team 46*!"""})
st.markdown("<h1 style='text-align: center; color: black;'>Biz-Card-Visualization</h1>", unsafe_allow_html=True)
st.markdown("<h1 style='text-align: center; color: red;'>EXTRACTING BUSINESS CARD DATA WITH 'OCR'</h1>", unsafe_allow_html=True)
st.title("")
selected = option_menu(None, ["Home","Upload & Modifying","Delete"], 
                       icons=["house","cloud-upload","trash"],
                       default_index=0,
                       orientation="horizontal",
                       styles={"nav-link": {"font-size": "35px", "text-align": "centre", "margin": "0px", "--red-color": " #FF0000"},
                               "icon": {"font-size": "35px"},
                               "container" : {"max-width": "6000px"},
                               "nav-link-selected": {"background-color": "#6495ED"}})

if selected == "Home":
    st.markdown("<h3 style='color: red;'>Technologies Used :</h3> <p style='color: black;'>Python, easy OCR, Streamlit, SQL, Pandas.</p>",unsafe_allow_html=True)
    st.markdown("<h3 style='color: red;'>About :</h3> <p style='color: black;'>Bizcard is a Python application designed to extract information from business cards.</p>",unsafe_allow_html=True)
    st.markdown("<h3 style='color: red;'>Done By :</h3> <h4 style='color: black;'>INFANT ANDREW R</h4>",unsafe_allow_html=True)
    st.markdown("<h3 style='color: black;'>The main purpose of Bizcard is to automate the process of extracting key details from business card images, such as the name, designation, company, contact information, and other relevant data. By leveraging the power of OCR (Optical Character Recognition) provided by EasyOCR, Bizcard is able to extract text from the images.</h3>", unsafe_allow_html=True)


elif selected == "Upload & Modifying":
  ...
  method =  option_menu("select mode", ["None","Preview","Modify"])
